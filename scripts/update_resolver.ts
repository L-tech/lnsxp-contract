...
const addressTwo = "0xfD15D0bf913bE0B7d3A2DDaf8f857Ad48D56013e";
const baseNode = namehash.hash('test')


const TldName = "resolver.link";
...
//   const tryit = await cntraact.resolver("0x0e451ab80a411882dde5df2cc62010c3a4eb1b610bc7bfe8ebb3b5b7382fb6d1", {
//     ...overrides
//   });
//   console.log(tryit);
